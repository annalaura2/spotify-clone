    ...
    return (
        <div className={Styles.main}>
            ...
            <span className={Styles.termos}>
                Ao entrar, criar uma conta ou ouvir nossas músicas, você está de acordo com os <a href='https://github.com/annalaura2' rel='noreferrer' target='_blank'>termos de serviço e a política de privacidade</a> do {CONSTS_SISTEMA.NOME_SISTEMA}
            </span>
        </div>
    )
}